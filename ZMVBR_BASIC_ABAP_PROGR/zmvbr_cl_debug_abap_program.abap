...
CLASS zmvbr_cl_debug_abap_program DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zmvbr_cl_debug_abap_program IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    DO.
      ...
      DO months_btw_spec_pay TIMES.
        ...
        " deduct repayment
        loan_remaining -= repayment_month.
      ...
      loan_remaining -= special_repayment.
